        ...
        <div className='py-12'>
            ...
            <div className='text-center space-y-4'>
                ...
                <form className='flex flex-col md:flex-row justify-center items-center mb-4 md:px-24'>
                    <input type="text" placeholder='Search phone by name' className='bg-white border border-gray-300 focus:outline-none focus:shadow-outline rounded shadow-md w-2/3 h-12 px-4 mb-3 md:mb-0 md:mr-2 ' />
